...
/* harmony import */ var _shared_auth_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./shared/auth.service */ "./src/app/shared/auth.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                _material_module__WEBPACK_IMPORTED_MODULE_11__["MyMaterialModule"]
            ],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_list_contents_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/list-contents.service */ "./src/app/shared/list-contents.service.ts");



var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(getContent) {
        this.getContent = getContent;
        this.var1 = 'Welcome';
    }
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getContent.get().subscribe(function (data) {
            console.log(data);
            if (data.ls_contents) {
                _this.var2 = data.ls_contents;
                console.log(_this.var2[0]);
            }
        });
    };
    DashboardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_list_contents_service__WEBPACK_IMPORTED_MODULE_2__["ListContentsService"]])
    ], DashboardComponent);
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, authServ, router) {
        this.fb = fb;
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authServ.login(username, password).subscribe(function (data) {
            if (data.token) {
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _shared_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], LoginComponent);
...
var ServiceComponent = /** @class */ (function () {
    function ServiceComponent(fileServ) {
        this.fileServ = fileServ;
    }
    ServiceComponent.prototype.ngOnInit = function () {
        this.fileServ.get().subscribe(function (data) {
            console.log(data);
        });
    };
    ServiceComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_file_service__WEBPACK_IMPORTED_MODULE_2__["FileService"]])
    ], ServiceComponent);
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (uname, pass) {
        var authHeaderValue = 'Basic ' + btoa(uname + ':' + pass);
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', authHeaderValue);
...
var FileService = /** @class */ (function () {
    ...
    FileService.prototype.get = function () {
        var authorization = localStorage.getItem('session');
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('x-access-token', authorization);
        return this.http.get(this.baseUrl, { headers: headers });
    };
...
/***/ "./src/app/shared/list-contents.service.ts":
/*!*************************************************!*\
  !*** ./src/app/shared/list-contents.service.ts ***!
  \*************************************************/
/*! exports provided: ListContentsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ListContentsService", function() { return ListContentsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
...
var ListContentsService = /** @class */ (function () {
    function ListContentsService(http) {
        this.http = http;
        this.baseUrl = '/api/get-directory-contents';
    }
    ListContentsService.prototype.get = function () {
        var token = localStorage.getItem('session');
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('x-access-token', token);
        return this.http.get(this.baseUrl, { headers: headers });
    };
    ListContentsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
    ], ListContentsService);
    return ListContentsService;
}());
...
module.exports = __webpack_require__(/*! /home/sagar/DeptWork/Project/pucsd_cloud_api/pucsd-cloud-ui/src/main.ts */"./src/main.ts");
